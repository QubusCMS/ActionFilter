<?php
namespace Qubus\Hooks;

use Qubus\Hooks\Interfaces\ActionFilterHookInterface;
use Qubus\Hooks\Interfaces\RemoveAllActionsHookInterface;
use Qubus\Hooks\Interfaces\RemoveAllFiltersHookInterface;
use Qubus\Hooks\Interfaces\ApplyFilterRefArrayHookInterface;
use Qubus\Hooks\Interfaces\DoActionRefArrayHookInterface;
use Qubus\Hooks\Interfaces\DidActionHookInterface;
use Qubus\Hooks\Interfaces\HasFilterHookInterface;
use Qubus\Hooks\Interfaces\HasActionHookInterface;
